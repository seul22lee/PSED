...
def process_paper(paper_dir):
    ...
    figs_json = paper_dir / STEP["02"] / "filtered" / "filtered_figures.json"
    plot_dir=paper_dir/STEP["03"]
    out_dir=paper_dir/STEP["05"]
    ...
    for plot_file in plot_files:
        ...
        for panel_i,panel in enumerate(pdata):
            ...
            enriched = {
                ...
                "legend": meta.get("legend", []),          # ← 추가
                "x_label": meta.get("x_label", ""),        # ← 추가
                "y_label": meta.get("y_label", ""),        # ← 추가
