...
# psed_v1 layout: pipeline stages live in pipeline/, the twin in twin/.
# These two paths once named folders outside the project,
# so this report could not be regenerated at all.
ROOT = Path(__file__).resolve().parent
REPO = ROOT.parent
from pipeline.resolve import kb_service                      # noqa: E402
from pipeline.resolve import process_id                      # noqa: E402
from pipeline.resolve import recipe as recipe_mod            # noqa: E402
from twin import kb_bridge                       # noqa: E402
from twin.channel_model import channelModel, MODEL_ID  # noqa: E402

DERIVED = P.CORPUS_OUT / "kb_derived"
...
<div class=note style="margin-top:8px">Each run is appended to <span class=m>papers/_corpus/kb_derived/orchestrator_runs.json</span> — the write-back arrow the stateless Argonne agents lack. Every result carries provenance (papers, parameter sources) so downstream can trust and cite it.</div></div>
</div>"""
