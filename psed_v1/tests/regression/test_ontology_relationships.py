...
_sp = u.spec_from_file_location("viz", _PSED_ROOT / "ontology" / "visualize_ontology.py")
viz = u.module_from_spec(_sp); _sp.loader.exec_module(viz)
ONTO = json.loads((P.ONTOLOGY_JSON).read_text())
HTML = (_PSED_ROOT / "ontology" / "ontology.html").read_text()
...
gen = (_PSED_ROOT / "ontology" / "visualize_ontology.py").read_text()
