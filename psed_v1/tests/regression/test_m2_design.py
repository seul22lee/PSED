...
src = _project.path("twin","m2_design.py").read_text()
...
ok("only one canonical M2 artifact on disk",
   not _project.path("twin","m2_design_report.html").exists()
   and not _project.path("twin","m2_design_report_infeasible.html").exists(),
...
try:
    from twin import inverse_solver as _inv
