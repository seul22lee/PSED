...
- Updated PMC Dataset (COCO format) is available from [HERE](https://drive.google.com/file/d/1YZmRy9TcaOJ6tA8DLeG0sXhSjwqqAw_h/view?usp=sharing), please unzip it to 'data/' folder.
- Models can be accessed in [HERE](https://drive.google.com/file/d/1htEEzRVE9Qlppz8ZgyEPJ3OI1HHY6gDS/view?usp=sharing), please download them and unzip them to 'work_dirs/' folder.
