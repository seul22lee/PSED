...
Usage:
    python3 scripts/canonical_audit.py --all
"""
...
# this is a developer utility under scripts/, not part of the canonical package
from pipeline.canonical import sources as S                       # noqa: E402
from pipeline.canonical import units as U                         # noqa: E402
from pipeline.canonical.axis_semantics import (                   # noqa: E402
    REVIEW_THRESHOLD, canon_quantity as _canon)
from pipeline.canonical.schema import (REPO, Status, COMPARISON_GROUPS,  # noqa: E402
                                       NORMALIZATION_DEFINITIONS, RULE_DECLS,
                                       code_version, build_timestamp)
