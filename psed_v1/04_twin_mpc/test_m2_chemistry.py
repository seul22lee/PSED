...
SYNTH = [
    exp("paperA", "Al2O3", "TMA", "H2O",
        [cond("pressure", 50.0, "A", "Pa"), cond("pulse_time", 0.10, "A", "s"),
         cond("pulse_time", 1.0, "B", "s")]),
    exp("paperB", "Al2O3", "TMA", "O3",
        [cond("pressure", 200.0, "A", "Pa"), cond("pulse_time", 2.0, "A", "s")]),
    exp("paperC", "Al2O3", None, None, [cond("pressure", 7.0, None, "Pa")]),
]
...
pp = mc.scoped_condition_prior(SYNTH, "precursor_partial_pressure", "pressure", "A",
                               "Al2O3", "TMA", "H2O")
...
ppO3 = mc.scoped_condition_prior(SYNTH, "precursor_partial_pressure", "pressure", "A",
                                 "Al2O3", "TMA", "O3")
...
ppC = mc.scoped_condition_prior(SYNTH, "precursor_partial_pressure", "pressure", "A",
                                "Al2O3", None, None)
...
pp3 = mc.scoped_condition_prior(NOPRESS, "precursor_partial_pressure", "pressure", "A",
                                "Al2O3", "TMA", "H2O")
