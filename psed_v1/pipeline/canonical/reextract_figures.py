...
Needs google-genai and resources/config/corpus/.env:
    /home/ftk3187/miniconda3/envs/psed310/bin/python \
        python3 -m pipeline.canonical.reextract_figures --priority high
"""
...
def reextract(doi, figures, client, dry_run=False, resume=True):
    ...
    out_path.write_text(json.dumps({
        ...
        "generator": "python3 -m pipeline.canonical.reextract_figures",
        "model": MODEL,
