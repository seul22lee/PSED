...
Usage:
    python3 -m pipeline.canonical.validate --all
    python3 -m pipeline.canonical.validate --paper 10.1039_d0cp03358h
...
def validate_ontology_determinism(rep):
    ...
    import subprocess
    onto = P.ONTOLOGY_JSON
    before = onto.read_bytes()
    try:
        subprocess.check_output([sys.executable, str(P.ONTOLOGY_DIR / "build_ontology.py")],
