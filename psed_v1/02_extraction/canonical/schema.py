...
ROOT = Path(__file__).resolve().parent.parent          # 02_extraction/
REPO = ROOT.parent                                     # psed_v1/
ONTOLOGY_PATH = REPO / "01_ontology" / "ald_ontology.json"
...
if not (TRANSFORMATION_STATUSES and TRANSFORMATION_TYPES and COMPARISON_GROUPS):
    raise RuntimeError(
        ...
        "run: python3 01_ontology/build_ontology.py")
...
class TransformationRecord(dict):
    ...
    def make(axis, rule_id, rule_version, ttype, formula, status,
        ...
        return TransformationRecord({
            ...
            "source": source or {},
            "created_by": "02_extraction/canonical/build_canonical.py",
