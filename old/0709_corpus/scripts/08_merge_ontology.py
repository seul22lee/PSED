...
proposed/proposed_ontology.yaml into 0706_ontology/core_extensions.yaml (a safe overlay
...
Then: python3 0706_ontology/build_ontology.py     # rebuild the ontology JSON.
"""
import sys
...
def main():
    ...
    print("  now run: python3 0706_ontology/build_ontology.py")
